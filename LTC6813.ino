...
#define FREQ_PIN 33
//current threshold for ready to drive
#define THRESHOLD 5
...
void loop() {
  ...
  state_of_charge.begin(update_soc,1000000);
  //only attempt data upload if SD card funcitonal
  if(SD_readable){
